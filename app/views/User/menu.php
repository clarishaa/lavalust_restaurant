    ...
    <div class="container">
      ...
      <ul class="filters_menu">
        ...
        <?php foreach ($category_data as $categ) : ?>
          <li data-filter=".<?= $categ['category_id'] ?>"><?= $categ['name'] ?></li>
        <?php endforeach; ?>
      </ul>
      <div class="filters-content">
        <div class="row grid">
          <?php foreach ($menu_data as $item) : ?>
            ...
            <div class="col-sm-6 col-lg-4 all <?= $item['category_id'] ?>">
              <div class="box" style="position: relative; height: 400px;">
                <div>
                  <div class="img-box" style="height: 100%; overflow: hidden;">
                    <img src="<?= $item['img_path'] ?>" alt="" style="object-fit: cover;">
                  </div>
                    ...
                    <div class="options row mt-4">
                      ...
                      <div class="col-6 text-right ">
                        <form action="/cart" method="post">
                          ...
                          <button type="submit" class="btn rounded-circle p-2" style="background-color: #ffbe33;">
