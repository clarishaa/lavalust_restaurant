            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Reservations Management</li>
                    </ol>
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data as $staffs) : ?>
                                        <tr>
                                            ...
                                            <td><?= $staffs['mobile'] ?></td>
                                            <td><?= $staffs['bookdate'] ?></td>
                                            <td><?= $staffs['booktime'] ?></td>
                                            <td><?= $staffs['message'] ?></td>
                                            <td><?= $staffs['booking_status'] ?></td>

                                            <td class="action-buttons">
                                                <a href="<?= site_url('book-cancel/' . $staffs['booking_id']) ?>" class="btn btn-danger">Cancel</a>
                                                <a href="<?= site_url('book-payed/' . $staffs['booking_id']) ?>" class="btn btn-primary">Confirm</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
