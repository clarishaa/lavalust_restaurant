                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Customers
                            <a href="<?= site_url('add-customer/') ?>" class="btn btn-primary float-end" data-toggle="modal" data-target="#addModal">Add</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <?php foreach ($customers as $customer) : ?>
                                        <tr>
                                            ...
                                            <td class="action-buttons">
                                                <a href="<?= site_url('customer-delete/' . $customer['user_id']) ?>" class="btn btn-danger">Delete</a>
                                                <a href="<?= site_url('customer-edit/' . $customer['user_id']) ?>" class="btn btn-primary" data-toggle="modal" data-target="#editModal<?= $customer['user_id'] ?>">Edit</a>
                                            </td>

                                        </tr>
                                        <div class="modal fade" id="editModal<?= $customer['user_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel<?= $customer['user_id'] ?>" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= site_url('customer-update/' . $customer['user_id']) ?>" method="post" enctype="multipart/form-data">
                                                            <div class="form-group">
                                                                <label for="fName">First Name:</label>
                                                                <input type="text" class="form-control" id="itemName" name="fname" value="<?= $customer['first_name'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="lName">Last Name:</label>
                                                                <input type="text" class="form-control" id="itemName" name="lname" value="<?= $customer['last_name'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" class="form-control" id="mobile" name="password" value="<?= $customer['password'] ?>">
                                                            </div>
                                    ...
                                    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?= site_url('add-customer/') ?>" method="post" enctype="multipart/form-data">
                                                        <div class="form-group">
                                                            <label for="fName">First Name:</label>
